...
OUTPUT_DIR="../original_rebel/outputs_${ETA}"
HF_REPO_NAME="qwen2.5_3B_Instruct_rebel_${ETA}"  # Change this to your desired repo name
EVAL_RESULTS_DIR="../qwen2.5_3B_Instruct_rebel_evaluation_results"  # Directory to save evaluation results
...
accelerate launch \
    ...
    src/ultrafeedback_largebatch/rebel.py \
