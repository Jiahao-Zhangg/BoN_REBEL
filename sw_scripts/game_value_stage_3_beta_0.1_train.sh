...
# Parameters
# -----------------------------
DATASET_REPO="zjhhhh/stage3_mean_beta_0.1_multi_expand_tokenized_gap_0.22_logprob"
JUDGE_MODEL="Qwen/Qwen3-14B"
OUTPUT_REPO_PREFIX="zjhhhh/game_stage3_train_beta_0.1"
...
CHECKPOINT_REPO_2="zjhhhh/qwen2.5_3B_Instruct_min_stage3_seed_555134_eta_1e4_step_201"
CHECKPOINT_REPO_3="zjhhhh/qwen2.5_3B_Instruct_min_stage3_seed_555134_eta_1e4_step_301"
CHECKPOINT_REPO_4="zjhhhh/qwen2.5_3B_Instruct_min_stage3_seed_555134_eta_1e4_step_382_final"
CHECKPOINT_REPO_5="zjhhhh/qwen2.5_3B_Instruct_multi_stage3_seed_555134_beta_0.1_step_1"
CHECKPOINT_REPO_6="zjhhhh/qwen2.5_3B_Instruct_multi_stage3_seed_555134_beta_0.1_step_201"
CHECKPOINT_REPO_7="zjhhhh/qwen2.5_3B_Instruct_multi_stage3_seed_555134_beta_0.1_step_301"
CHECKPOINT_REPO_8="zjhhhh/qwen2.5_3B_Instruct_multi_stage3_seed_555134_beta_0.1_step_382_final"
...
bash sw_scripts/game_value_parallel.sh \
  ...
  --extra_args_base "--n_response $N_RESPONSE --world_size 2 --base_gpus 0,1 --temperature 0.8 --end_idx $SAMPLE_SIZE --split train" \
  --extra_args_eval "--world_size 1 --n_response $N_RESPONSE --n_judge_samples $N_JUDGE_SAMPLES --model_temperature 0.1 --switch_position" \
  --extra_args_score "--beta 0.1"
