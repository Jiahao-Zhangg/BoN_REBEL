...
#SBATCH --job-name=fullcheck_multi_generate_node1
#SBATCH --output=logs/fullcheck_multi_generate_node1_%j.out
#SBATCH --error=logs/fullcheck_multi_generate_node1_%j.err
#SBATCH --ntasks=1
...
# Node 1: Handle jobs 0-7 (data indices 0-15999)
# TOTAL_GPUS=8, START_IDX=0, NUM_JOBS=8, CHUNK_SIZE=2000
...
wait
echo "All jobs completed on Node 1."
