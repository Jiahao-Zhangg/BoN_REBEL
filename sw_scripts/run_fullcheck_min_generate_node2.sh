...
#SBATCH --job-name=fullcheck_min_generate_node2
#SBATCH --output=logs/fullcheck_min_generate_node2_%j.out
#SBATCH --error=logs/fullcheck_min_generate_node2_%j.err
#SBATCH --ntasks=1
...
CHUNK_SIZE="2000"
NUM_JOBS="8"
MODEL="zjhhhh/fullcheck_min_step_382_final"
OUTPUT_PREFIX="Qwen3b_iter1_fullcheck_min_"
GPU_MEM_UTIL="0.8"
EXTRA_ARGS=""
