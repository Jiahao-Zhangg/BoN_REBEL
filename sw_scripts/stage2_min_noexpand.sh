...
HF_REPO_NAME="zjhhhh/qwen2.5_3B_Instruct_min_stage2_seed_${SEED}_eta_${ETA}_noexpand"
EVAL_RESULTS_DIR="/fsx/gstevenw/qwen2.5_3B_Instruct_min_evaluation_results"

# Derived configuration
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))

TRAIN_INPUT_REPO="zjhhhh/stage2_preprocessed_beta_1.0_min_noexpand_tokenized"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/stage2_preprocessed_beta_1.0_min_noexpand_tokenized"
