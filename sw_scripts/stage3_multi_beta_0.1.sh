...
TMP_RUN_ROOT="${TMP_BASE%/}/multi_stage3_${USER}/${JOB_RUN_ID}"
mkdir -p "$TMP_RUN_ROOT"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/multi_stage3_beta_0.1_eta_1e4.out"
LOG_ERR="${LOG_DIR%/}/multi_stage3_beta_0.1_eta_1e4.err"
mkdir -p "$LOG_DIR"
...
SECONDS=0
OUTPUT_DIR="${TMP_RUN_ROOT}/outputs_seed_${SEED}_beta_${BETA}"
HF_REPO_NAME="zjhhhh/qwen2.5_3B_Instruct_multi_stage3_seed_${SEED}_beta_${BETA}"
EVAL_RESULTS_DIR="/fsx/gstevenw/qwen2.5_3B_Instruct_multi_evaluation_results"

# Derived configuration
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))

TRAIN_INPUT_REPO="zjhhhh/stage3_mean_beta_0.1_multi_expand_tokenized_gap_0.22"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/stage3_mean_beta_0.1_multi_expand_tokenized_gap_0.22"
