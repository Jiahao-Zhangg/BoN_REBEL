...
TRAIN_INPUT_REPO="zjhhhh/stage1_mean_beta_1.0_multi_expand_tokenized_gap_0.22"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/stage1_mean_beta_1.0_multi_expand_tokenized_gap_0.22"
