...
#SBATCH --job-name=inference_3b_iter2_rlcf_H100
#SBATCH --output=logs/inference_3b_iter2_rlcf_H100_%A_%a.out
#SBATCH --error=logs/inference_3b_iter2_rlcf_H100_%A_%a.err
#SBATCH --array=0-5%2
#SBATCH --nodes=1
#SBATCH --ntasks=1
