#!/bin/bash
#SBATCH --job-name=7b_fullcheck_gap_0.17_0.15iter2
#SBATCH --output=logs/7b_fullcheck_gap_0.17_0.15iter2_%A.out
#SBATCH --error=logs/7b_fullcheck_gap_0.17_0.15iter2_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
ETA="1e2"                     # REBEL eta parameter
BETA="1"
TOTAL_EPISODES="37200"         # Episodes fed to rebel.py --total_episodes
...
TMP_RUN_ROOT="${TMP_BASE%/}/7b_fullcheck_gap_0.17_0.15iter2_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-7b_fullcheck_gap_0.17_0.15iter2_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/7b_fullcheck_gap_0.17_0.15iter2.out"
LOG_ERR="${LOG_DIR%/}/7b_fullcheck_gap_0.17_0.15iter2.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/7b_fullcheck_gap_0.17_0.15iter2"

############################
# Training configuration   #
############################
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))
TRAIN_INPUT_REPO="zjhhhh/7b_fullcheck_iter2_beta_1.0_multi_expand_tokenized_gap_ratio_0.15"
