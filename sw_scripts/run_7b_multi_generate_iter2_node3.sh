...
#SBATCH --job-name=7b_multi_generate_iter2_node3
#SBATCH --output=logs/7b_multi_generate_iter2_node3_%j.out
#SBATCH --error=logs/7b_multi_generate_iter2_node3_%j.err
#SBATCH --ntasks=1
