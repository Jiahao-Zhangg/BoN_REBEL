...
#SBATCH --job-name=inference_multi_gpu_iter2_ver2_H100
#SBATCH --output=logs/inference_iter2_ver2_H100_%A_%a.out
#SBATCH --error=logs/inference_iter2_ver2_H100_%A_%a.err
#SBATCH --array=0-5%2
#SBATCH --nodes=1
#SBATCH --ntasks=1
