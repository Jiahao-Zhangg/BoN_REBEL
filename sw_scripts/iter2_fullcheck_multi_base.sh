#!/bin/bash
#SBATCH --job-name=iter2_fullcheck_multi_base
#SBATCH --output=logs/iter2_fullcheck_multi_base_%A.out
#SBATCH --error=logs/iter2_fullcheck_multi_base_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TMP_RUN_ROOT="${TMP_BASE%/}/iter2_fullcheck_multi_base_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-iter2_fullcheck_multi_base_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/iter2_fullcheck_multi_base.out"
LOG_ERR="${LOG_DIR%/}/iter2_fullcheck_multi_base.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/iter2_fullcheck_multi_base"

############################
# Training configuration   #
############################
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))
TRAIN_INPUT_REPO="zjhhhh/iter2_fullcheck_multi_base_beta_1.0_multi_expand_tokenized_gap_ratio_0.22"
