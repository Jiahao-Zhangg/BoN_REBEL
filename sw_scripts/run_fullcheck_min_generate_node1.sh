...
#SBATCH --job-name=fullcheck_min_generate_node1
#SBATCH --output=logs/fullcheck_min_generate_node1_%j.out
#SBATCH --error=logs/fullcheck_min_generate_node1_%j.err
#SBATCH --ntasks=1
