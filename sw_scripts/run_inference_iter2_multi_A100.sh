...
# Usage: sbatch run_inference_iter2_multi_A100.sh
#SBATCH --job-name=inference_multi_gpu_iter2_multi_A100
#SBATCH --output=logs/inference_iter2_multi_A100_%A_%a.out
#SBATCH --error=logs/inference_iter2_multi_A100_%A_%a.err
#SBATCH --array=0-2
#SBATCH --nodes=1
#SBATCH --ntasks=1
