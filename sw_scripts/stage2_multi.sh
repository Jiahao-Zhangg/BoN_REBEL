...
TMP_BASE="${TMPDIR:-../tmp}"
TMP_RUN_ROOT="${TMP_BASE%/}/multi_stage1_${USER}/${JOB_RUN_ID}"
mkdir -p "$TMP_RUN_ROOT"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/multi_stage1_eta_1e4.out"
LOG_ERR="${LOG_DIR%/}/multi_stage1_eta_1e4.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/qwen2.5_3B_Instruct_multi_stage1_seed_${SEED}_eta_${ETA}"
