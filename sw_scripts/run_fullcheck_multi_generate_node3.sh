...
#SBATCH --job-name=fullcheck_multi_generate_node3
#SBATCH --output=logs/fullcheck_multi_generate_node3_%j.out
#SBATCH --error=logs/fullcheck_multi_generate_node3_%j.err
#SBATCH --ntasks=1
...
# Node 3: Handle jobs 16-23 (data indices 32000-47999)
# TOTAL_GPUS=8, START_IDX=32000, NUM_JOBS=8, CHUNK_SIZE=2000
...
wait
echo "All jobs completed on Node 3."
