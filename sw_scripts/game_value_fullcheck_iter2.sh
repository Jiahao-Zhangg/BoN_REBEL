...
#SBATCH --job-name=fullcheck_multi_iter2_game_value
#SBATCH --output=logs/fullcheck_multi_iter2_game_value_%j.out
#SBATCH --error=logs/fullcheck_multi_iter2_game_value_%j.err
#SBATCH --ntasks=1
...
OUTPUT_REPO_PREFIX="zjhhhh/game_fullcheck_multi_iter2"
