#!/bin/bash
#SBATCH --job-name=7b_multi_perprompt_iter1_1e4   
#SBATCH --output=logs/7b_multi_perprompt_iter1_1e4_%A.out
#SBATCH --error=logs/7b_multi_perprompt_iter1_1e4_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
