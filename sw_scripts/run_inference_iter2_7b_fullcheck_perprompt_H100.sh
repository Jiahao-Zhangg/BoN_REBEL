...
# Usage: sbatch run_inference_iter2_7b_fullcheck_perprompt_H100.sh
#SBATCH --job-name=inference_iter2_7b_fullcheck_perprompt_H100
#SBATCH --output=logs/inference_iter2_7b_fullcheck_perprompt_H100_%A_%a.out
#SBATCH --error=logs/inference_iter2_7b_fullcheck_perprompt_H100_%A_%a.err
#SBATCH --array=0-5%2
#SBATCH --nodes=1
#SBATCH --ntasks=1
