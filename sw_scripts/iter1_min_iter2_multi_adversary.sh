#!/bin/bash
#SBATCH --job-name=iter1_min_iter2_multi_adversary
#SBATCH --output=logs/iter1_min_iter2_multi_adversary_%A.out
#SBATCH --error=logs/iter1_min_iter2_multi_adversary_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TMP_RUN_ROOT="${TMP_BASE%/}/iter1_min_iter2_multi_adversary_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-iter1_min_iter2_multi_adversary_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/iter1_min_iter2_multi_adversary.out"
LOG_ERR="${LOG_DIR%/}/iter1_min_iter2_multi_adversary.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/iter1_min_iter2_multi_adversary"

############################
# Training configuration   #
############################
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))
TRAIN_INPUT_REPO="zjhhhh/iter1_min_iter2_multi_adversary_mean_beta_1.0_multi_expand_tokenized_gap_ratio_0.22"
