#!/bin/bash
#SBATCH --job-name=7b_multi_perprompt_iter1_1e5
#SBATCH --output=logs/7b_multi_perprompt_iter1_1e5_%A.out
#SBATCH --error=logs/7b_multi_perprompt_iter1_1e5_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
