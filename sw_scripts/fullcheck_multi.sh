...
TMP_RUN_ROOT="${TMP_BASE%/}/fullcheck_multi_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-fullcheck_multi_beta_${BETA}_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/fullcheck_multi_beta_1.out"
LOG_ERR="${LOG_DIR%/}/fullcheck_multi_beta_1.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/fullcheck_multi_beta_1.0"
...
TRAIN_INPUT_REPO="zjhhhh/fullcheck_base_beta_1.0_multi_expand_tokenized_gap_ratio_0.22"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/fullcheck_base_beta_1.0_multi_expand_tokenized_gap_ratio_0.22"
