...
#SBATCH --job-name=fullcheck_min_generate_node3
#SBATCH --output=logs/fullcheck_min_generate_node3_%j.out
#SBATCH --error=logs/fullcheck_min_generate_node3_%j.err
#SBATCH --ntasks=1
