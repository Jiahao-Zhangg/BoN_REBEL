...
#SBATCH --job-name=7b_multi_perprompt_iter2_generate
#SBATCH --output=logs/7b_multi_perprompt_iter2_generate_%A_%a.out
#SBATCH --error=logs/7b_multi_perprompt_iter2_generate_%A_%a.err
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
OUTPUT_PREFIX="Qwen7b_multi_perprompt_iter1_"
GPU_MEM_UTIL="0.8"
EXTRA_ARGS=""
