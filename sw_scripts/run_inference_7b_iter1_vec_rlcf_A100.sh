...
#SBATCH --job-name=inference_7b_iter1_vec_rlcf_A100
#SBATCH --output=logs/inference_7b_iter1_vec_rlcf_A100_%A_%a.out
#SBATCH --error=logs/inference_7b_iter1_vec_rlcf_A100_%A_%a.err
#SBATCH --array=0-2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
OUTPUT_DIR="./inference_scores_7b_iter1_vec_rlcf"
...
run_inference() {
    ...
    (
        ...
        python $SCRIPT_PATH \
            ...
            --current_pairs 2 \
            --push_to_hub \
            --hf_repo_template zjhhhh/7b_iter1_vec_rlcf_scores_{shard_idx} \
