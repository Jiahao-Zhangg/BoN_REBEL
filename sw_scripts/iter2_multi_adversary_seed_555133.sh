#!/bin/bash
#SBATCH --job-name=iter2_multi_adversary_seed_555133
#SBATCH --output=logs/iter2_multi_adversary_seed_555133_%A.out
#SBATCH --error=logs/iter2_multi_adversary_seed_555133_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SEED="555133"               # Random seed for reproducible runs
JOB_RUN_ID="${JOB_RUN_ID:-$(date +%s)}"
TMP_BASE="/fsx/gstevenw/testing_alignment_algos/BoN_REBEL/tmp"
TMP_RUN_ROOT="${TMP_BASE%/}/iter2_multi_adversary_seed_555133_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-iter2_multi_adversary_seed_555133_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/iter2_multi_adversary_seed_555133.out"
LOG_ERR="${LOG_DIR%/}/iter2_multi_adversary_seed_555133.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/iter2_multi_adversary_seed_555133"
