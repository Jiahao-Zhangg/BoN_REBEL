#!/bin/bash
# SLURM script to run min perprompt robust inference across 48 shards using 6 jobs on H100
# Each job runs 8 Python scripts on different single GPUs (0,1,2,3,4,5,6,7)
# Shards 0-47 (48 total shards)
# Usage: sbatch run_inference_iter2_7b_min_perprompt_H100.sh
#SBATCH --job-name=inference_iter2_7b_min_perprompt_H100
#SBATCH --output=logs/inference_iter2_7b_min_perprompt_H100_%A_%a.out
#SBATCH --error=logs/inference_iter2_7b_min_perprompt_H100_%A_%a.err
#SBATCH --array=0-5%2
#SBATCH --nodes=1
#SBATCH --ntasks=1
