...
TMP_RUN_ROOT="${TMP_BASE%/}/iter2_base_min_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-iter2_base_min_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/iter2_base_min.out"
LOG_ERR="${LOG_DIR%/}/iter2_base_min.err"
mkdir -p "$LOG_DIR"
...
TRAIN_INPUT_REPO="zjhhhh/iter2_base_min_expand_ver2_tokenized_gap_ratio_0.22"
