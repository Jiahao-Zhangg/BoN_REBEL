...
BETA="1"
TOTAL_EPISODES="48000"         # Episodes fed to rebel.py --total_episodes
...
TMP_RUN_ROOT="${TMP_BASE%/}/iter2_base_min_ver1_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-iter2_base_min_ver1_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/iter2_base_min_ver1.out"
LOG_ERR="${LOG_DIR%/}/iter2_base_min_ver1.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/iter2_base_min_ver1"

############################
# Training configuration   #
############################
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))
TRAIN_INPUT_REPO="zjhhhh/iter2_base_min_expand_ver1_tokenized_gap_ratio_0.22"
