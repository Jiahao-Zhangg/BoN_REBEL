...
OUTPUT_REPO_PREFIX="zjhhhh/game_full_multi_iter2_full"
...
# Sample checkpoints
CHECKPOINT_REPO_1="zjhhhh/iter2_fullcheck_multi_adversary_eta_1e3_step_367_final"
CHECKPOINT_REPO_2="zjhhhh/iter2_fullcheck_multi_adversary_eta_1e2_step_367_final"

# Group checkpoints per GPU
CHECK_POINT_GROUPS="${CHECKPOINT_REPO_1} ${CHECKPOINT_REPO_2}"
