...
# Usage: sbatch run_inference_iter2_7b_min_A100.sh
#SBATCH --job-name=inference_multi_gpu_iter2_7b_min_A100
#SBATCH --output=logs/inference_iter2_7b_min_A100_%A_%a.out
#SBATCH --error=logs/inference_iter2_7b_min_A100_%A_%a.err
#SBATCH --array=0-2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
SHARD_DIR="./iter2_7b_min_shards"
OUTPUT_DIR="./inference_scores_iter2_7b_min"
...
run_inference() {
    ...
    (
        ...
        python $SCRIPT_PATH \
            ...
            --switch_position \
            --push_to_hub \
            --hf_repo_template zjhhhh/iter2_7b_min_scores_{target}_{shard_idx} \
