#!/bin/bash
#SBATCH --job-name=7b_rlcf_iter1_uniweights_expand  
#SBATCH --output=logs/7b_rlcf_iter1_uniweights_expand_%A.out
#SBATCH --error=logs/7b_rlcf_iter1_uniweights_expand_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TMP_RUN_ROOT="${TMP_BASE%/}/7b_rlcf_iter1_uniweights_expand_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-7b_rlcf_iter1_uniweights_expand_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/7b_rlcf_iter1_uniweights_expand.out"
LOG_ERR="${LOG_DIR%/}/7b_rlcf_iter1_uniweights_expand.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/7b_rlcf_iter1_uniweights_expand"

############################
# Training configuration   #
############################
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))
TRAIN_INPUT_REPO="zjhhhh/7b_iter1_rlcf_uniweights_rlcf_expand_tokenized_gap_ratio_0.22"
