...
#SBATCH --job-name=fullcheck_multi_generate_node2
#SBATCH --output=logs/fullcheck_multi_generate_node2_%j.out
#SBATCH --error=logs/fullcheck_multi_generate_node2_%j.err
#SBATCH --ntasks=1
...
# Node 2: Handle jobs 8-15 (data indices 16000-31999)
# TOTAL_GPUS=8, START_IDX=16000, NUM_JOBS=8, CHUNK_SIZE=2000
...
CHUNK_SIZE="2000"
NUM_JOBS="8"
MODEL="zjhhhh/fullcheck_multi_beta_1.0_step_382_final"
OUTPUT_PREFIX="Qwen3b_iter1_fullcheck_multi_"
GPU_MEM_UTIL="0.8"
EXTRA_ARGS=""
...
wait
echo "All jobs completed on Node 2."
