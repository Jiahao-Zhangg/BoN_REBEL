#!/bin/bash
#SBATCH --job-name=iter2_fullcheck_multi_adversary_1e3
#SBATCH --output=logs/iter2_fullcheck_multi_adversary_1e3_%A.out
#SBATCH --error=logs/iter2_fullcheck_multi_adversary_1e3_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
