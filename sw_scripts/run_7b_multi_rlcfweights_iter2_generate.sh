...
#SBATCH --job-name=7b_multi_rlcfweights_iter2_generate
#SBATCH --output=logs/7b_multi_rlcfweights_iter2_generate_%A_%a.out
#SBATCH --error=logs/7b_multi_rlcfweights_iter2_generate_%A_%a.err
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
GPUS_PER_JOB="1"
CHUNK_SIZE="2000"
MODEL="zjhhhh/7b_multi_iter1_eta_1e3_rlcfweight_step_437_final"
OUTPUT_PREFIX="Qwen7b_multi_rlcfweights_iter1_"
GPU_MEM_UTIL="0.8"
EXTRA_ARGS=""
