...
#SBATCH --job-name=stage2_game_value_part2 
#SBATCH --output=logs/stage2_game_value_part2_%j.out
#SBATCH --error=logs/stage2_game_value_part2_%j.err
#SBATCH --ntasks=1
...
# Use 1 GPU per judge worker across 2 GPUs total
GPU_GROUPS="0 1"
