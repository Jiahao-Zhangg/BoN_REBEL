...
TMP_BASE="${TMPDIR:-../tmp}"
TMP_RUN_ROOT="${TMP_BASE%/}/min_rebel_gap_${USER}/${JOB_RUN_ID}"
mkdir -p "$TMP_RUN_ROOT"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/min_gap_eta_1e4_ver2.out"
LOG_ERR="${LOG_DIR%/}/min_gap_eta_1e4_ver2.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/qwen2.5_3B_Instruct_min_gap_seed_${SEED}_eta_${ETA}_ver2_H100"
# EVAL_RESULTS_DIR="/work2/$USER/qwen2.5_3B_Instruct_min_gap_evaluation_results"

# Derived configuration
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))

TRAIN_INPUT_REPO="zjhhhh/choose_gap_min_ver2_tokenized"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/choose_gap_min_ver2_tokenized"
