...
#SBATCH --job-name=fullcheck_min_generate_node4
#SBATCH --output=logs/fullcheck_min_generate_node4_%j.out
#SBATCH --error=logs/fullcheck_min_generate_node4_%j.err
#SBATCH --ntasks=1
