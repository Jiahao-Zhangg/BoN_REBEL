#!/bin/bash
#SBATCH --job-name=7b_iter2_multi_0.17
#SBATCH --output=logs/7b_iter2_multi_0.17_%A.out
#SBATCH --error=logs/7b_iter2_multi_0.17_%A.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
TMP_RUN_ROOT="${TMP_BASE%/}/7b_iter2_multi_0.17_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-7b_iter2_multi_0.17_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/7b_iter2_multi_0.17.out"
LOG_ERR="${LOG_DIR%/}/7b_iter2_multi_0.17.err"
mkdir -p "$LOG_DIR"
...
HF_REPO_NAME="zjhhhh/7b_iter2_multi_0.17"

############################
# Training configuration   #
############################
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))
TRAIN_INPUT_REPO="zjhhhh/iter2_7b_multi_gap_0.15_scores_mean_beta_1.0_multi_0.17_tokenized"
# Base model used to initialize training
BASE_MODEL="zjhhhh/7b_gap_0.15_multi_step_350_final"
