...
TMP_RUN_ROOT="${TMP_BASE%/}/min_fixed_stage2_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-stage2_min_fixed_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/min_stage2_fixed_beta_1.out"
LOG_ERR="${LOG_DIR%/}/min_stage2_fixed_beta_1.err"
mkdir -p "$LOG_DIR"
...
TRAIN_INPUT_REPO="zjhhhh/stage2_preprocessed_min_fixed_expand_tokenized_gap_0.22"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/stage2_preprocessed_min_fixed_expand_tokenized_gap_0.22"
