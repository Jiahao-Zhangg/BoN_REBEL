...
#SBATCH --job-name=inference_7b_iter1_vec_rlcf_H100
#SBATCH --output=logs/inference_7b_iter1_vec_rlcf_H100_%A_%a.out
#SBATCH --error=logs/inference_7b_iter1_vec_rlcf_H100_%A_%a.err
#SBATCH --array=0-5%2
#SBATCH --nodes=1
#SBATCH --ntasks=1
