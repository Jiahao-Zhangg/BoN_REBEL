...
CHECKPOINT_REPO_3=""zjhhhh/qwen2.5_3B_Instruct_min_stage1_seed_555134_eta_1e4_step_201""
CHECKPOINT_REPO_4=""zjhhhh/qwen2.5_3B_Instruct_min_stage1_seed_555134_eta_1e4_step_301""
CHECKPOINT_REPO_5=""zjhhhh/qwen2.5_3B_Instruct_min_stage1_seed_555134_eta_1e4_step_382_final""

SCORE_BASE_PATH="game_values"
mkdir -p "$SCORE_BASE_PATH"
SCORE_JSON_PATH="$SCORE_BASE_PATH/scores_stage1_min.json"
...
N_RESPONSE=4
SAMPLE_SIZE=200
OUTPUT_REPO_PREFIX="zjhhhh/game_stage1"

if [ -z "${CUDA_VISIBLE_DEVICES:-}" ]; then
    export CUDA_VISIBLE_DEVICES=$(seq -s, 4 $((WORLD_SIZE+3)))
fi
