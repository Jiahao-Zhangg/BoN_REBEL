...
BETA="1"
TOTAL_EPISODES="37000"         # Episodes fed to rebel.py --total_episodes
...
TMP_RUN_ROOT="${TMP_BASE%/}/multi_stage2_${USER}/${JOB_RUN_ID}"
...
RUN_NAME="${RUN_NAME:-stage2_multi_eta_${ETA}_beta_${BETA}_seed_${SEED}_${RUN_ID}}"

LOG_DIR="${REBEL_LOG_DIR:-../logs}"
LOG_OUT="${LOG_DIR%/}/multi_stage2_eta_1e4.out"
LOG_ERR="${LOG_DIR%/}/multi_stage2_eta_1e4.err"
mkdir -p "$LOG_DIR"
...
TRAIN_INPUT_REPO="zjhhhh/stage2_preprocessed_beta_1.0_multi_noexpand_tokenized"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/stage2_preprocessed_beta_1.0_multi_noexpand_tokenized"
