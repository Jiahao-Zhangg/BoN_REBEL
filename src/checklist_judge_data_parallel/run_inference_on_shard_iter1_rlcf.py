    ...
    with open(tmp_out_path, "w") as f:
        for oi in range(n_rows):
            ...
            for key in all_labels:
                ...
                row_out[key.replace("_score", "_mean")] = weighted_average(mean_numbers, mean_weights)
                row_out[key.replace("_score", "_majority")] = weighted_average(maj_numbers, maj_weights)
