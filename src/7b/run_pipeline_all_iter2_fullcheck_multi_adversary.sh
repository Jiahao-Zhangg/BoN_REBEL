...
RAW_REPO=${RAW_REPO:-"zjhhhh/iter2_fullcheck_multi_scores_adversary_rescaled"}
# NOCHECK_REPO=${NOCHECK_REPO:-"zjhhhh/whole_sw_maxlen_8192_nocheck_rescale"}
# OUTPUT_PREFIX=${OUTPUT_PREFIX:-"zjhhhh/iter2_adversary"}
ADVERSARY_OUTPUT_PREFIX=${ADVERSARY_OUTPUT_PREFIX:-"zjhhhh/iter2_fullcheck_multi_adversary"}
