...
CHECKPOINT_REPO="zjhhhh/qwen2.5_3B_Instruct_fixed_1_step_312_final"
JUDGE_MODEL="Qwen/Qwen3-14B"
OUTPUT_REPO_PREFIX="zjhhhh/qwen3_eval"
WORLD_SIZE=4
N_JUDGE_SAMPLES=5
DEFAULT_DATASET_REPO="zjhhhh/whole_sw_maxlen_8192_rescale_mean_maxlenp_1024_beta_1.0_fixed_tokenized_logprob"
