#!/bin/bash
#SBATCH --job-name=fixed-pipeline
...
OUTPUT_DIR="/project/flame/$USER/fixed_rebel/outputs_beta_${BETA}_eta_${ETA}"
HF_REPO_NAME="zjhhhh/qwen2.5_3B_Instruct_fixed_beta_${BETA}_eta_${ETA}"
EVAL_RESULTS_DIR="/project/flame/$USER/qwen2.5_3B_Instruct_fixed_evaluation_results"

# Derived configuration
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))

TRAIN_INPUT_REPO="zjhhhh/whole_sw_maxlen_8192_rescale_mean_maxlenp_1024_beta_1.0_fixed_tokenized"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/whole_sw_maxlen_8192_rescale_mean_maxlenp_1024_beta_1.0_fixed_tokenized"
...
mkdir -p "$EVAL_RESULTS_DIR"
EVAL_RESULTS_FILE="$EVAL_RESULTS_DIR/fixed_evaluation_beta_${BETA}_eta_${ETA}_$(date +%Y%m%d_%H%M%S).txt"
