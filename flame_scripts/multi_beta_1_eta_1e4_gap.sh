...
TMP_RUN_ROOT="${TMPDIR:-/tmp}/multi_rebel_gap_${USER}/${JOB_RUN_ID}"
OUTPUT_DIR="${TMP_RUN_ROOT}/outputs_seed_${SEED}_beta_${BETA}_eta_${ETA}"
HF_REPO_NAME="zjhhhh/qwen2.5_3B_Instruct_multi_gap_seed_${SEED}_beta_${BETA}_eta_${ETA}"
EVAL_RESULTS_DIR="/project/flame/$USER/qwen2.5_3B_Instruct_multi_gap_evaluation_results"

# Derived configuration
GRADIENT_ACCUMULATION_STEPS=$((128 / WORLD_SIZE))

TRAIN_INPUT_REPO="zjhhhh/choose_gap_beta_1_multi_tokenized"

# Evaluation configuration
BASE_MODEL="Qwen/Qwen2.5-3B-Instruct"
EVAL_DATASET_NAME="zjhhhh/choose_gap_beta_1_multi_tokenized"
